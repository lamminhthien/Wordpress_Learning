...
function cde_post_custom_meta_box() {
  add_meta_box( 'post-custom-field', __( 'Intro text', 'cde-theme' ), 'post_metabox_callback', 'page' ); //post_metabox_callback:hiển thị trên page(trình duyệt)
}
...
//thêm 1 text như đó thì ta double code
